...
const WelcomeSection = () => {
  ...
  const cards = [
    ...
    // Bottom row - 3 cards
    {
      id: 5,
      image: imageFive,
      title: t('card5Title') || "Ibsa Ahmed (PhD) — Vice president For Adminstration and development",
      description: t('card5Desc') || "Ibsa Ahmed supervises the administrative and developmental functions that sustain institutional growth and infrastructure. He ensures the strategic utilization of resources to support operational effectiveness. His office drives initiatives that enhance administrative efficiency and organizational advancement. Through forward-looking management practices, he strengthens institutional capacity and development outcomes."
    },
    {
      id: 6,
      image: imageSix,
      title: t('card6Title') || "Ahmedin Abdurahman (PhD) — Director, Quality assurance directorate",
      description: t('card6Desc') || "Ahmedin Abdurahman leads the institutional systems that safeguard academic standards and operational quality. He administers evaluation frameworks to ensure adherence to established benchmarks and regulatory requirements. His directorate promotes continuous improvement through systematic monitoring and assessment. Through quality-focused leadership, he reinforces institutional credibility and accountability."
    },
    {
      id: 7,
      image: imageSeven,
      title: t('card7Title') || "Mr. Ararsa Gudisa — Director, University registrar",
      description: t('card7Desc') || "Mr. Ararsa Gudisa manages the university's academic records and regulatory documentation processes. He ensures accuracy and integrity in admissions, enrollment, and certification procedures. His office coordinates academic progression in accordance with institutional regulations. Through meticulous administrative oversight, he maintains institutional trust and compliance."
    }
  ];
