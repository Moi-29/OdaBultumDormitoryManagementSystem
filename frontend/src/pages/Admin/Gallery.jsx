    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (imageUploadType === 'upload' && formData.imageFile) {
                ...
                if (modalMode === 'create') {
                    await axios.post(`${API_URL}/api/gallery`, formDataToSend, config);
                    showNotification('Image added successfully', 'success');
                } else if (modalMode === 'edit' && selectedImage) {
                    await axios.put(`${API_URL}/api/gallery/${selectedImage._id}`, formDataToSend, config);
                    showNotification('Image updated successfully', 'success');
                }
            } else if (formData.imageUrl) {
                // Use URL directly
                const imageData = { imageUrl: formData.imageUrl };
